 ...
 *
 * Note: ReactFlowProvider is at this level to allow both WorkflowCanvasInner
 * and StepConfigPanel to access React Flow hooks (e.g., useReactFlow).
 */
...
import { WorkflowCanvasInner } from "./Canvas/WorkflowCanvas";
